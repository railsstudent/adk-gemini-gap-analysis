...
export const rootAgent = new LlmAgent({
  ...
  instruction: `
    ...
    CRITICAL RULE: You MUST treat EVERY user input containing a question and answer as a brand new request. NEVER answer from memory or chat history. You MUST execute your tools every single time, even if the user provides the exact same input twice. You are FORBIDDEN from generating the final JSON output yourself.
    ...
    3. Return the final structured JSON result generated by the SequentialAuditFeedbackAgent.
